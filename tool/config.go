...
var _ binpack.Tool = (*compositeTool)(nil)

type compositeTool struct {
	config Config
	binpack.Installer
	binpack.VersionResolver
}
...
func New(t Config) (binpack.Tool, error) {
...
func getInstaller(method string, installParams any) (installer binpack.Installer, err error) {
	switch {
...
func getResolver(method string, params any) (resolver binpack.VersionResolver, err error) {
	switch {
